...
(
    ID int default next value for PROJECT_ID_SEQ primary key,
...
create sequence MAIL_CASE_ID_SEQ start with 1;

create table MAIL_CASE
(
    ID int default next value for MAIL_CASE_ID_SEQ primary key,
...
create table SPRINT
(
    ID int default next value for SPRINT_ID_SEQ primary key,
...
(
    ID int default next value for REFERENCE_ID_SEQ primary key,
    CODE       varchar(32)   not null,
...
create table USERS
(
    ID int default next value for USERS_ID_SEQ primary key,
...
create table TASK
(
    ID int default next value for TASK_ID_SEQ primary key,
    TITLE         varchar(1024) not null,
    DESCRIPTION   varchar(4096) not null,
    TYPE_CODE     varchar(32)   not null,
    STATUS_CODE   varchar(32)   not null,
...
(
    ID int default next value for ACTIVITY_ID_SEQ primary key,
...
create sequence USER_BELONG_ID_SEQ start with 1;

create table USER_BELONG
(
    ID int default next value for USER_BELONG_ID_SEQ primary key,
...
create sequence ATTACHMENT_ID_SEQ start with 1;

create table ATTACHMENT
(
    ID int default next value for ATTACHMENT_ID_SEQ primary key,
