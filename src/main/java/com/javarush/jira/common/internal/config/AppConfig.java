...
public class AppConfig {
    ...
    public DataSource prodDataSource() {
        ...
        dataSourceBuilder.url(env.getProperty("SPRING_DATASOURCE_URL"));
        dataSourceBuilder.username(env.getProperty("SPRING_DATASOURCE_USERNAME"));
        dataSourceBuilder.password(env.getProperty("SPRING_DATASOURCE_PASSWORD"));
